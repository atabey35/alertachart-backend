...
import { sendPriceAlertNotification, formatPriceString } from './unified-push.js';
...
export class AutoPriceAlertService {
  ...
  async sendNotificationToAll(symbol, name, emoji, currentPrice, targetPrice, direction) {
    try {
      ...
      const formattedCurrentTr = formatPriceString(currentPrice);
      ...
      const formattedCurrentEn = formatPriceString(currentPrice);
